...
def main():
    ...
    parser.add_argument("image_folder", type=str, help="Path to the folder containing PNG images.")
    parser.add_argument("output_video", type=str, help="Output path for the video file.")
